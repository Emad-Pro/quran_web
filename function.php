...
public $site_title = 'Quran Audio Library';
public $site_description = 'Listen to quran by different reciters';
...
if($language == "arabic"){
$word['title'] = 'المكتبة الصوتية للقرآن الكريم';
$word['home'] = 'الرئيسية';
$word['download'] = 'تحميل السورة';
$word['footer'] = '<p>برمجة <a target="_blank" href="http://www.nwahy.com">نواحي</a> - بدعم من <a target="_blank" title="mp3quran.net" href="http://www.mp3quran.net">MP3 Quran API</a> الحقوق محفوظة '.date('Y',time()).'</p>';
...
$word['footer'] = '<p>Programming by <a target="_blank" href="http://www.nwahy.com">Nwahy</a>, Copyright '.date('Y',time()).' <a target="_blank" title="mp3quran.net" href="http://www.mp3quran.net">MP3 Quran API</a>,All Rights Reserved.</p>';
